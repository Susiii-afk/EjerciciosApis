...
app = Flask(__name__)
app.secret_key = 'd3b3fef72af2471bafb08e6b1aa3f488'  # Cambiar por una clave secreta

# Spotify API Credentials
CLIENT_ID = 'f22031a48400446ca75a686f69cae947'
CLIENT_SECRET = 'd3b3fef72af2471bafb08e6b1aa3f488'
...
if __name__ == '__main__':
    ...
    print("🌐 Servidor corriendo en: https://127.0.0.1:5000")
    print("=" * 60)
